...
Для изготовления тира с тремя карточками нам понадобятся:
  ...
  - [[amp>product/servo-fs90|Микросервопривод FS90 ×3]]

===== Как это собрать? =====

  - Извлеките микросхему из платы Arduino Uno. {{ :projects:vr_build_0.jpg?direct&700 }}
  - Установите на Arduino плату EasyVR, перемычку на EasyVR в положение «PC». {{ :projects:vr_build_1.jpg?direct&700 }}
...
===== Что ещё можно сделать? =====
  ...
  возможностей. Помимо распознавания голоса на английском языке модуль
  способен:

  - Распознавать команды на некоторых других языках (Немецкий, Французский, Итальянский, Испанский, Корейский и Японский).
